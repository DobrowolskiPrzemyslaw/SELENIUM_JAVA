...
import seleniumUdemy.driver.DriverManager;
...
public class BaseElements {
    ...
    protected WebElement waitUnilPresentedBase(){         // czeka, aż element będzie istnial na stronie - nie wazne czy jest widoczny i klikalny
